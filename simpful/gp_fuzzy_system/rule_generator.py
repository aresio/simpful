...
class RuleGenerator:
    def __init__(self, variable_store, output_variable="ArbitraryVariable", verbose=False):
    ...
    def generate_rules(self, max_rules, min_clauses=2, max_clauses=5, verbose=False):
        ...
        rules = [
            self.generate_rule(random.randint(min_clauses, max_clauses), rule_index=i + 1, verbose=verbose)
