...
class TestFitnessFunctions(unittest.TestCase):
    ...
    def test_weighted_rmse(self):
        predicted = self.system.predict_with_fis(
            data=self.system.x_train, variable_store=self.variable_store
        )
    ...
    def test_evaluate_fitness(self):
        ...
        fitness = self.system.evaluate_fitness(
            variable_store=self.variable_store, weights=weights
        )
