...
Simpful supports Mamdani and Sugeno reasoning of any order, parsing complex fuzzy rules involving AND, OR, and NOT operators, using arbitrarily shaped fuzzy sets.
